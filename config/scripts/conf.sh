...
choices=("i3-config" "i3-workspaces" "i3-colors" "sxhkd" "polybar" "alacritty" "ranger" "themes" "alt+c_Menue" "startup-sequence" "autostart")
...
case $selected_choice in
    ...
    "themes")
        ...
        ;;
    "startup-sequence")
        config_file="$HOME/.config/i3/autostart.sh"
        ;;
	"autostart")
        config_file="$HOME/.config/i3/autostart.sh"
         ;;
    "alt+c_Menue")
        config_file="$HOME/.config/scripts/conf.sh"
         ;;
    *)
        echo "Invalid choice"
        exit 1
